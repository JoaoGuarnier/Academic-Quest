...
public class ProjetoControllerMockTest {
    ...
    public void setUpProjetoControllerMock() throws Exception {
        ...
        when(projetoService.buscarPorMateriaId(projetoId)).thenReturn(projetoDTO);
        when(projetoService.buscarPorMateriaId(notProjetoId)).thenThrow(MateriaNaoEncontradaException.class);
